...
const ArtistRoom = () => {
    const {homeWidth,allArtists,allSongs,capital} = useContext(DataContext)
  ...
  return (
    <main className='w-full rounded-md'>
      ...
      <section className='w-full p-4 my-5 h-20 flex items-center'>
        ...
        <div className=' Flex h-14 w-14 mr-7 hover:scale-105 cursor-pointer bg-green-500 rounded-full outline-none shadow-none'>
